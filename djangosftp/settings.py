"""
Django settings for djangosftp project.
...
SECRET_KEY = '-1t9p)o_jg$meghylly(&ex0#rsw70t#+gk9(tr$zt)s9(n+cr'
...
WSGI_APPLICATION = 'djangosftp.wsgi.application'
